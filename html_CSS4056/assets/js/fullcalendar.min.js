...
(function(m, oa) {
        ...
        function f(u) {
            ...
            (u = b.header[u]) && m.each(u.split(" "), function(na) {
                ...
                m.each(this.split(","), function(ra, sa) {
                    if (sa == "title") {
                        fa.append("<span class='fc-header-title'><h2>&nbsp;</h2><a onclick='next()' class='next'></a><a onclick='prev()' class='prev'></a></span>");
                        ...
                        if (ha) {
                            ...
                            var da = jb(b.buttonText, sa),
                                ma = m("<span class='fc-button fc-button-" + sa + " " + q + "-state-default'><span class='fc-button-inner'><span class='fc-button-content'>" + (ra ? "<span class='fc-icon-wrap'><span class='ui-icon ui-icon-" +
                                    ra + "'/></span>" : da) + "</span><span class='fc-button-effect'><span></span></span></span></span><div class='time-selection'><div class='time-first'><span><em>8</em>am</span><a onclick='upTime(this)' href='javascript:;' class='arrow-up'></a><a onclick='downTime(this)' href='javascript:;' class='arrow-dn'></a></div><div class='time-second'><span><em>11</em>pm</span><a onclick='upTime(this)' href='javascript:;' class='arrow-up'></a><a onclick='downTime(this)' href='javascript:;' class='arrow-dn'></a></div></div>");
                            if (ma) {
                                ma.click(function() {  
    ...
    function kb(a, b) {
        ...
        if (typeof a == "string") {
            if (a.match(/^\d+$/)) return new Date(parseInt(a,
                10) * 1E3);
            if (b === oa) b = true;
    ...
    function ic(a) {
        return (parseFloat(m.curCSS(a[0], "marginLeft",
            true)) || 0) + (parseFloat(m.curCSS(a[0], "marginRight", true)) || 0)
    }
    ...
    function kc(a) {
        return (parseFloat(m.curCSS(a[0],
            "borderTopWidth", true)) || 0) + (parseFloat(m.curCSS(a[0], "borderBottomWidth", true)) || 0)
    }
    ...
    function sc() {
        ...
        function l(o, s) {
            ...
            v += " class='" + M.join(" ") + "' style='position:absolute;z-index:8;top:" + s.top + "px;left:" + s.left + "px;" + r + "'><div class='fc-event-inner fc-event-skin'" + J + "><div class='fc-event-head fc-event-skin'" + J + "><div class='fc-event-time'>" + Qa(W(o.start, o.end, u("timeFormat"))) + "</div></div><div class='fc-event-content'><a class='uparrow'></a><a class='downarrow'></a><div class='fc-event-title'>" + Qa(o.title) + "</div></div><div class='fc-event-bg'></div></div>";
    ...
    var Ya = {
            defaultView: "agendaWeek", //month,agendaWeek,agendaDay
            aspectRatio: 1.35,
            header: {
                left: "title",
                center: "",
            ...
            columnFormat: {
                month: "ddd",
                //week: "ddd M/d",
                 week: "<em>ddd</em> MMM d", //customize code
                day: "dddd M/d"
            },
            timeFormat: {
                "": "h(:mm)t"
